...
(function($){
		...
		var list = function(target){//列出数据 target目标div指 定义选择数据的div
			...
			if(o.data.length>0){//如果有标签数据
				...
				for(var i in o.data){//循环标签数据
					...
					if(o.color == 3){
						index = o.data[i].screen
						color = o.colorData[index]
						attr.style="background:"+color[0]+";color:"+color[1]+";"
					}
	...
	$.fn.sTags.defaults = {
		...
		color:3,//标签列表颜色，0不使用，1按screen的首字母，按顺序循环数组内颜色，2随机颜色，数组内颜色，值0为背景色，1为字色
		colorData:[
			["rgba(232,29,29, 0.2)","#373737"],
			["rgba(0,116,217, 0.2)","#373737"],
			["rgba(46,204,64, 0.2)","#373737"],
			["rgba(255,133,27, 0.2)","#373737"],
			["rgba(177,13,201, 0.2)","#373737"],
			["rgba(61,153,112, 0.2)","#373737"],
			["rgba(255,65,54, 0.2)","#373737"],
			["rgba(0,31,63, 0.2)","#373737"],
			["rgba(133,20,75, 0.2)","#373737"],
			["rgba(57,204,204, 0.2)","#373737"],
			["rgba(255,220,0, 0.2)","#373737"],
			["rgba(17,17,17, 0.2)","#373737"],
			["rgba(170,170,170, 0.2)","#373737"],
			["rgba(102,51,153, 0.2)","#373737"],
			["rgba(65,105,225, 0.2)","#373737"],
			["rgba(139,0,139, 0.2)","#373737"],
			["rgba(34,139,34, 0.2)","#373737"],
			["rgba(240,18,190, 0.2)","#373737"],
			["rgba(160,82,45, 0.2)","#373737"],
			["rgba(127,255,212, 0.2)","#373737"],
			["rgba(210,105,30, 0.2)","#373737"],
			["rgba(85,107,47, 0.2)","#373737"],
			["rgba(153,50,204, 0.2)","#373737"],
			["rgba(128,128,0, 0.2)","#373737"],
			["rgba(0,128,128, 0.2)","#373737"],
			["rgba(70,130,180, 0.2)","#373737"],
			["rgba(0,139,139, 0.2)","#373737"],
			["rgba(106,90,205, 0.2)","#373737"],
			["rgba(255,105,180, 0.2)","#373737"],
			["rgba(205,92,92, 0.2)","#373737"],
			["rgba(173,255,47, 0.2)","#373737"],
			["rgba(72,209,204, 0.2)","#373737"],
			["rgba(90, 3, 3, 0.2)","#373737"],
			["rgba(88, 44, 109, 0.2)","#373737"],
			["rgba(174, 28, 93, 0.2)","#373737"],
			["rgba(30, 74, 10, 0.2)","#373737"],
			["rgba(180, 13, 19, 0.2)","#373737"],
			["rgba(149, 179, 16, 0.2)","#373737"],
			["rgba(24, 165, 197, 0.2)","#373737"],
			["rgba(45, 218, 57, 0.2)","#373737"],
			["rgba(4, 187, 178, 0.2)","#373737"],
			["rgba(141,182,242, 0.2)","#373737"],
			["rgba(53, 165, 53, 0.2)","#373737"],
			["rgba(240, 49, 55, 0.2)","#373737"],
			["rgba(29, 17, 134, 0.2)","#373737"],
			["rgba(233, 88, 182, 0.2)","#373737"],
			["rgba(202, 66, 17, 0.2)","#373737"],
			["rgba(43, 25, 206, 0.2)","#373737"],
			["rgba(23, 224, 157, 0.2)","#373737"],
			["rgba(104, 73, 216, 0.2)","#373737"],
			["rgba(239, 84, 206, 0.2)","#373737"],
			["rgba(13, 160, 193, 0.2)","#373737"],
			["rgba(91, 180, 85, 0.2)","#373737"],
			["rgba(11, 100, 168, 0.2)","#373737"],
			["rgba(88, 225, 20, 0.2)","#373737"],
